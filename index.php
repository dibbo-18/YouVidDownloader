...
<head>
    ...
    <meta name="description" content="Download Your Favorite Youtube Videos with just one click. You can download in any formats and HD Quality."/>
    <meta name="keywords" content="YouTube video downloader,Online youtube video downloading site, HD quality video, youtube videos, Downloader tool, youtube, video downloader"/>
    
    
    <link rel="shortcut icon" href="image/favicon.png">
    
    <title> Online You_Tube Video Downloader </title>
    ...
    <link rel="stylesheet" href="stylesheet/style-2.css">
    <style>
        .formSmall {
            width: 330px;
  ...
  <section class="header">      
    ...
    <div class="container">
        <form method="post" action="" class="formSmall">
            <center><a href="index.php"><img src="image/image.png"width="320"></a></center>
            <div class="row">
                <div class="col-lg-12">
   ...
   <h1 class="footer-text">
       &copy All Copyrights are Reserved<br> 
        by YouVidDownloder
   </h1>
